...
console.log("Full names", full_name);


// Array.prototype.sort()
// 3. Sort the inventors by birthdate, oldest to youngest    
const sorted2 = inventors.sort((a, b) => a.year > b.year ? 1 : -1);
...
const oldestInv = inventors.sort(function (a, b) {
...
const data2 = data.reduce((obj, item) => {
    if (!obj[item]) {
        obj[item] = 0
    }
    obj[item]++;
